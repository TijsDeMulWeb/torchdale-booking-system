            ...
            <div class="space-y-12 sm:space-y-16">
                <div
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="firstName" class="block text-sm/6 font-medium text-gray-900 dark:text-white sm:pt-1.5">Voornaam</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            <input id="firstName" type="text" name="first_name"
                                value="{{ old('first_name', $customer->first_name) }}" autocomplete="given-name"
                                class="block w-full rounded-md bg-gray-100 dark:bg-white/5 px-3 py-1.5 text-base text-gray-900 dark:text-white outline-1 -outline-offset-1 outline-gray-300 dark:outline-white/10 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:max-w-md sm:text-sm/6" />
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="email" class="block text-sm/6 font-medium text-gray-900 dark:text-white sm:pt-1.5">Email</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="street" class="block text-sm/6 font-medium text-gray-900 dark:text-white sm:pt-1.5">Straat</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="city" class="block text-sm/6 font-medium text-gray-900 dark:text-white sm:pt-1.5">Stad</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                    ...
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="country" class="block text-sm/6 font-medium text-gray-900 dark:text-white sm:pt-1.5">Land</label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
