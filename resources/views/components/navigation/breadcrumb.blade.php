...
<nav aria-label="Breadcrumb" class="flex border-b border-gray-200 bg-white dark:border-white/10 dark:bg-gray-900">
  <ol role="list" class="mx-auto flex w-full space-x-4 px-4 sm:px-6 lg:px-8">
    <li class="flex">
      <div class="flex items-center">
        <a href="{{ route('dashboard.show') }}" class="text-gray-400 hover:text-gray-500 dark:text-gray-400 dark:hover:text-gray-300">
          ...
          <span class="sr-only">{{ __('nav.dashboard') }}</span>
        </a>
      </div>
    </li>
    ...
    <li class="flex">
      <div class="flex items-center">
        ...
        <a href="{{ $breadcrumb['url'] }}" class="ml-4 text-sm font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200">{{ $breadcrumb['name'] }}</a>
      </div>
    </li>
    @endforeach
  </ol>
