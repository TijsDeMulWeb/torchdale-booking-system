            ...
            <el-dialog-panel
                ...
                <div
                    ...
                    <div class="relative flex h-16 shrink-0 items-center">
                        <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ Auth()->user()->escaperoom->name }}</span>
                    </div>
...
<div class="hidden bg-gray-900 lg:fixed lg:inset-y-0 lg:z-50 lg:flex lg:w-72 lg:flex-col">
    ...
    <div
        ...
        <div class="relative flex h-16 shrink-0 items-center">
            <span
                class="text-sm font-semibold text-gray-900 dark:text-white">{{ Auth()->user()->escaperoom->name }}</span>
        </div>
