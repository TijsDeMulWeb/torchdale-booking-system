...
<div class="space-y-12 sm:space-y-16">
    <div>
        <h2 class="text-base/7 font-semibold text-gray-900 dark:text-white">Rol</h2>
        <p class="mt-1 max-w-2xl text-sm/6 text-gray-600 dark:text-gray-400">Geef de rol een naam en kies welke
            rechten deze rol krijgt.</p>
        <div
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                ...
                <div class="mt-2 sm:col-span-2 sm:mt-0">
                    <input id="name" type="text" name="name" placeholder="Bijv. Medewerker"
    ...
    <div>
        <h2 class="text-base/7 font-semibold text-gray-900 dark:text-white">Rechten</h2>
        <p class="mt-1 max-w-2xl text-sm/6 text-gray-600 dark:text-gray-400">Kies welke onderdelen van het systeem
            deze rol mag bekijken en beheren.</p>
                        ...
                        @foreach ($permissions as $permission)
                            <div class="flex items-center gap-2">
                                ...
                                <label for="permission-{{ Str::slug($permission) }}"
                                    class="text-sm text-gray-700 dark:text-gray-300">{{ $permission }}</label>
                            </div>
                        @endforeach
                    </div>
                </div>
